...
Page({
  ...
  menuTap: function (event) {
    ...
    if (ids.indexOf(id) > -1) {
      this.setData({
        clothesList: clothesAll[ids.indexOf(id)][this.data.blockItem],
  ...
  blockTap: function (event) {
    ...
    //const ids = this.data.ids;
    const clothesAll = this.data.clothesAll;
    const clothesList = this.data.clothesAll[page][this.data.blockItem];
    //console.log("page",page,"id",id,"COTHELIST",clothesList,"indexof",ids.indexOf(id))
    this.setData({
        clothesList:this.data.clothesAll[page][this.data.blockItem]
    })
  },
